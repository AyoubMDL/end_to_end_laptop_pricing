...
class DataIngestionConfig:
    ...
    raw_data_path: str = os.path.join("artifacts", "data", "laptop_price_data.csv")
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df = pd.read_csv("notebook/laptop_price_data.csv")
            logging.info("Loaded the dataset as a dataframe")
